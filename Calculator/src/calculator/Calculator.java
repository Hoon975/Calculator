...
public class Calculator extends JFrame {
	...
	public Calculator() {
		...
		inputSpace.setBounds(7, 10, 290, 70);
		
		JPanel buttonPanel = new JPanel();
		buttonPanel.setLayout(new GridLayout(5, 4, 10, 10));
		buttonPanel.setBounds(7, 100, 290, 250);
		...
		for (int i = 0; i < button_names.length; i++) {
			...
			else if (button_names[i] == "=") buttons[i].setBackground(Color.DARK_GRAY);
			else if ((i >= 4 && i <= 6) || (i >= 8 && i <= 10) || (i >= 12 && i <= 14) || (i >= 16 && i <= 18)) buttons[i].setBackground(Color.BLUE);
	...
	class PadActionListener implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			if (operation.equals("C")) {
				...
				} else if (!inputSpace.getText().equals("") && !prev_operation.equals("+") && !prev_operation.equals("-") && !prev_operation.equals("×") && !prev_operation.equals("÷")&& !prev_operation.equals("%")) {
					inputSpace.setText(inputSpace.getText() + e.getActionCommand());
				}
			} else {
				inputSpace.setText(inputSpace.getText() + e.getActionCommand());
	...
	public double calculate(String inputText) {
		...
		for (int i = 0; i < equation.size(); i++) {
			...
			if (s.equals("+")) {
				...
				if ((mode.equals("mul") || mode.equals("div")|| mode.equals("mod")) && !s.equals("+") && !s.equals("-") && !s.equals("×") && !s.equals("÷")) {
